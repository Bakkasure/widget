...
def test_filter_by_currency(
    transactions: list[dict], usd_transaction: list[dict], rub_transaction: list[dict]
) -> None:
    result = filter_by_currency(transactions, "USD")
    assert list(result) == usd_transaction
    result = filter_by_currency(transactions, "RUB")
    assert list(result) == rub_transaction
